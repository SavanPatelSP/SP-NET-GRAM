const lang = {
  ...
  'SP NET GRAMPremiumSubscribedTitle': 'You are all set!',
  'SP NET GRAMPremiumSubscribedSubtitle': 'Thank you for subscribing to **SP NET GRAM Premium**.\nHere’s what is now unlocked.',
  'SP NET GRAMPremiumPeerTitle': '%s is a subscriber of **SP NET GRAM Premium**',
  'SP NET GRAMPremiumPeerSubtitle': 'Owners of **SP NET GRAM Premium** accounts have exclusive access to multiple additional features.',
  'SP NET GRAMPremiumPeerTitleEmojiStatus': '%s set this emoji from [%s]() as their current status.',
  'SP NET GRAMPremiumPeerTitleEmojiStatusNoPack': '%s set this emoji as their current status.',
  'SP NET GRAMPremiumPeerSubtitleEmojiStatus': 'Emoji statuses are a premium feature. Other features included in **SP NET GRAM Premium**:',
  ...
  'SP NET GRAMFeatures': 'SP NET GRAM Features',
  ...
  'GiftSP NET GRAMPremiumTitle': 'Gift SP NET GRAM Premium',
  'GiftSP NET GRAMPremiumDescription': 'Give **%1$s** access to exclusive features with **SP NET GRAM Premium**.',
  ...
  'BoostingDate': 'Date',
  'BoostingSP NET GRAMPremiumFor': 'SP NET GRAM Premium for %s',
  ...
  'SP NET GRAMPremiumUserGiftedPremiumDialogTitleWithPlural': '**%1$s** has gifted you a %2$s subscription to SP NET GRAM Premium.',
  'SP NET GRAMPremiumUserGiftedPremiumDialogTitleWithPluralSomeone': 'Someone has gifted you a %1$s subscription to SP NET GRAM Premium.',
  'SP NET GRAMPremiumUserGiftedPremiumDialogSubtitle': 'You now have access to additional features.',
  'SP NET GRAMPremiumUserGiftedPremiumOutboundDialogSubtitle': '**%1$s** now has access to additional features.',
  'GiftMonths': {
    'one_value': '%1$d-month',
    'other_value': '%1$d-months'
  },
  ...
  'SP NET GRAMStars': 'SP NET GRAM Stars',
  ...
  'MenuSP NET GRAMStars': 'My Stars',
  'MenuSP NET GRAMStarsTon': 'My TON',
  'StarsCount': {
    'one_value': '%d Star',
    'other_value': '%d Stars'
  },
  ...
  'StarGiftValueAboutLastSP NET GRAM': 'This is the price at which **%s** was last sold on SP NET GRAM',
  ...
  'StarGiftViewResaleSP NET GRAM': '%s for sale on SP NET GRAM %s',
  ...
  'SP NET GRAMStarsGift': 'Gift Stars to Friends',
  'StarsSentText': {
  ...
  'Chat.Service.PeerJoinedSP NET GRAM': '%@ joined SP NET GRAM',
