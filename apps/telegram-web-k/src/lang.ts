const lang = {
  ...
  'ChatList.Main.EmptyPlaceholder.Subtitle': 'You have %s on SP NET GRAM',
  'ChatList.Main.EmptyPlaceholder.SubtitleNoContacts': 'Use SP NET GRAM on your [Android](https://telegram.org/android) or [iOS](https://telegram.org/dl/ios) device to sync your contacts',
  ...
  'Deactivated.Subtitle': 'SP NET GRAM supports only one active tab with the app.\nClick anywhere to continue using this tab.',
  'Deactivated.Version.Title': 'WebK has updated...',
  'Deactivated.Version.Subtitle': 'Another tab is running a newer version of SP NET GRAM.\nClick anywhere to reload this tab.',
  ...
  'Notifications.Default': 'Give SP NET GRAM permission to send notifications. You may need to refresh the page to see the changes.',
  ...
  'Message.Unsupported.Desktop': '__This message is currently not supported on SP NET GRAM Web. Try [getdesktop.telegram.org](https://getdesktop.telegram.org/)__',
  'Message.Unsupported.Mobile': '__This message is currently not supported on SP NET GRAM Web. Try [telegram.org/dl](https://telegram.org/dl/)__',
  ...
  'PushNotification.Message.Refreshing': 'SP NET GRAM is syncing in the background...',
  'LogOut.Description': 'Are you sure you want to log out?\n\nNote that you can seamlessly use SP NET GRAM on all your devices at once.',
  // "PushNotification.Action.Mute1d.Success": "Notification settings were successfully saved.",
  // it is from iOS
  ...
  'Video.Unsupported.Desktop': '__Unfortunately, this video can\'t be played on SP NET GRAM Web. Try opening it with our [desktop app](https://getdesktop.telegram.org/) instead.__',
  'Video.Unsupported.Mobile': '__Unfortunately, this video can\'t be played on SP NET GRAM Web. Try opening it with our [mobile app](https://telegram.org/dl/) instead.__',
  ...
  'BoostsViaGifts.EndSubtitle': {
    'one_value': 'Choose when %d subscriber of your channel will receive SP NET GRAM Premium.',
    'other_value': 'Choose when %d subscribers of your channel will be randomly selected to receive SP NET GRAM Premium.'
  },
  ...
  'BoostsViaGifts.DurationSubtitle': 'You can review the list of features and terms of use for SP NET GRAM Premium [here]().',
  ...
  'Giveaway.Info': 'On **%s**, SP NET GRAM will automatically select %s **%s**.',
  'Giveaway.Info.End': 'On **%s**, SP NET GRAM automatically selected %s **%s**.',
  'Giveaway.Info.Date': 'On **%s**, SP NET GRAM will automatically select %s **%s** after **%s**.',
  'Giveaway.Info.Date.End': 'On **%s**, SP NET GRAM automatically selected %s **%s** after **%s**.',
  'Giveaway.Info.Several': 'On **%s**, SP NET GRAM will automatically select %s **%s** and %s.',
  'Giveaway.Info.Several.End': 'On **%s**, SP NET GRAM automatically selected %s **%s** and %s.',
  'Giveaway.Info.Several.Date': 'On **%s**, SP NET GRAM will automatically select %s **%s** and %s after **%s**.',
  'Giveaway.Info.Several.Date.End': 'On **%s**, SP NET GRAM automatically selected %s **%s** and %s after **%s**.',
  ...
  'Multiplier': '%s x %s',
  'Giveaway.Results': {
    'one_value': '%d winner of the giveaway was randomly selected by SP NET GRAM and received private message with giftcode.',
    'other_value': '%d winners of the giveaway were randomly selected by SP NET GRAM and received private messages with giftcodes.'
  },
  ...
  'Giveaway.Results.NoWinners': {
    'one_value': 'Due to the giveaway terms, no winner could be selected by SP NET GRAM, **1** gift link was forwarded to channel administrators.',
    'other_value': 'Due to the giveaway terms, no winners could be selected by SP NET GRAM, all **%d** gift links were forwarded to channel administrators.'
  },
  'Giveaway.Results.NoWinners.Stars': 'Due to the giveaway terms, no winners could be selected by SP NET GRAM, all stars were credited to channel administrators.',
  ...
  'BoostsViaGifts.AdditionalPrizesSubtitleOff': 'Turn this on if you want to give the winners your own prizes in addition to SP NET GRAM Premium subscriptions.',
  'BoostsViaGifts.AdditionalPrizesDetailed': {
    'one_value': '**%d** SP NET GRAM Premium subscription for %s',
    'other_value': '**%d** SP NET GRAM Premium subscriptions for %s'
  },
  'BoostsViaGifts.AdditionalPrizesDetailedWith': {
    'one_value': '**%d** %s with SP NET GRAM Premium subscription for %s',
    'other_value': '**%d** %s with SP NET GRAM Premium subscriptions for %s'
  },
  ...
  'Giveaway.With': 'with',
  'Giveaway.WithSubscriptionsSingle': 'SP NET GRAM Premium subscription for %s',
  'Giveaway.WithSubscriptionsPlural': 'SP NET GRAM Premium subscriptions for %s',
  'Giveaway.WithStars': {
  ...
  'Giveaway.Results.Subtitle': {
    'one_value': '%1$d winner of the **[Giveaway]()** was randomly selected by SP NET GRAM.',
    'other_value': '%1$d winners of the **[Giveaway]()** were randomly selected by SP NET GRAM.'
  },
  ...
  'GiftCode.ShareReceived': 'This link allows you or **[anyone you choose]()** to activate a **SP NET GRAM Premium** subscription.',
  'GiftModal.Title.You': 'You gifted **%1$s** a %2$s subscription to SP NET GRAM Premium.',
  ...
  'SimilarChannels.Unlock': {
    'one_value': 'Subscribe to **[SP NET GRAM Premium]()** to unlock up to **%d** similar channel.',
    'other_value': 'Subscribe to **[SP NET GRAM Premium]()** to unlock up to **%d** similar channels.'
  },
  ...
  'Boost.GetMoreBoosts': {
    'one_value': 'To boost **%1$s**, get **%2$d** more boost by gifting **SP NET GRAM Premium** to a friend.',
    'other_value': 'To boost **%1$s**, get **%2$d** more boosts by gifting **SP NET GRAM Premium** to a friend.'
  },
  'Boost.Reassign.Description': 'To boost **%1$s**, reassign a previous boost or %2$s to a friend to get %3$s.',
  'Boost.GiftPremium': '**[gift SP NET GRAM Premium]()**',
  'Boost.Additional': {
  ...
  'Boost.Reassign.Wait': 'Wait until the boost is available or get %s by gifting a **[SP NET GRAM Premium]()** subscription.',
  ...
  'Privacy.VoiceMessagesPremiumCaption': 'Subscribe to SP NET GRAM Premium to restrict who can send you voice or video messages.\n\n**[What is SP NET GRAM Premium?]()**',
  ...
  'PrivacySettings.Messages.PremiumError': 'Only subscribers of [SP NET GRAM Premium]() can restrict receiving messages.',
  ...
  'OnlyPremiumCanMessage': '**%s** only accepts messages from contacts and **[SP NET GRAM Premium]()** subscribers.',
  ...
  'Rtmp.MediaViewer.Failed.Description': 'SP NET GRAM doesn\'t see any stream coming from your streaming app. Please make sure you entered the right Server URL and Stream Key in your app.',
  ...
  'MultiAccount.AccountsLimitDescription': 'You have reached the limit of **3** connected accounts. You can add more by subscribing to **SP NET GRAM Premium**.',
  ...
  'InviteViaLink.Premium.Subscribe': 'Subscribe to SP NET GRAM Premium',
  ...
  'Frozen.Violation.Subtitle': 'Your account was frozen for breaking SP NET GRAM’s Terms of Service.',
  ...
  'Verified.Bot': 'This bot is verified as official by the representatives of SP NET GRAM.',
  'Verified.Channel': 'This channel was verified by SP NET GRAM.',
  'Verified.Group': 'This group was verified by SP NET GRAM.',
  // 'SavedMessages.Count': {
  ...
  'Summary.Limited.Text': 'Subscribe to [SP NET GRAM Premium]() to increase summary limits.',
  ...
  'ContactJoined': 'Contact joined SP NET GRAM',
  'Loading': 'Loading...',
  'Unblock': 'Unblock',
  ...
  'PrivacyPhoneInfo': 'Users who have your number saved in their contacts will also see it on SP NET GRAM.',
  'PrivacyPhoneInfo3': 'Users who add your number to their contacts will see it on SP NET GRAM only if they are your contacts.',
  ...
  'UsernameHelp': 'You can choose a username on **SP NET GRAM**. If you do, people will be able to find you by this username and contact you without needing your phone number.\n\nYou can use **a–z**, **0–9** and underscores. Minimum length is **5** characters.',
  'Phone': 'Phone',
  ...
  'YourEmailSkipWarningText': 'No, seriously.\n\nIf you forget your password, you will lose access to your SP NET GRAM account. There will be no way to restore it.',
  ...
  'NoUsernameFound': 'There is no SP NET GRAM account with this username.',
  ...
  'AppName': 'SP NET GRAM',
  'SpNetGramTitle': 'SP NET GRAM',
  'SpNetGramSettingsInfo': 'Assistant, SPG ID, Premium, SP Coin, Gems',
  'SpNetGramSectionTitle': 'SP NET GRAM Features',
  'SpNetGramAssistant': 'Assistant',
  'SpNetGramAssistantSubtitle': 'Chat with the SP NET GRAM Assistant',
  'SpNetGramAssistantInfo': 'Your SP NET GRAM Assistant helps with summaries, quick replies, and automation. This client view will expand as backend services are enabled.',
  'SpNetGramAssistantDemoResponse': 'Hello! I’m your SP NET GRAM Assistant. This is a local demo response.',
  'SpNetGramRunDemo': 'Run Demo',
  'SpNetGramAssistantToast': 'Assistant demo complete.',
  'SpNetGramId': 'SPG ID',
  'SpNetGramIdSubtitle': 'Your unique SP NET GRAM identity',
  'SpNetGramIdInfo': 'Create and manage your SPG ID to share a consistent profile across SP NET GRAM apps.',
  'SpNetGramMint': 'Mint',
  'SpNetGramToastMinted': 'SPG ID minted: %1$s',
  'SpNetGramSpgStatusMissing': 'SPG ID: not minted',
  'SpNetGramPremiumPlan': 'Premium Plan',
  'SpNetGramPremiumPlanSubtitle': 'Unlock SP NET GRAM Premium',
  'SpNetGramPremiumPlanInfo': 'Premium unlocks advanced privacy options, larger uploads, and early access to new features.',
  'SpNetGramPremiumPlanLabel': 'Plan: %1$s',
  'SpNetGramTogglePremium': 'Toggle',
  'SpNetGramManageAccess': 'Manage',
  'SpNetGramUpgrade': 'Upgrade',
  'SpNetGramStatusLoading': 'Loading…',
  'SpNetGramRefresh': 'Refresh',
  'SpNetGramPremiumActive': 'Premium status: active',
  'SpNetGramPremiumInactive': 'Premium status: inactive',
  'SpNetGramPremiumOnToast': 'Premium enabled.',
  'SpNetGramPremiumOffToast': 'Premium disabled.',
  'SpNetGramCoinAirdrop': 'SP Coin Airdrop',
  'SpNetGramCoinAirdropSubtitle': 'Wallet and airdrop status',
  'SpNetGramCoinAirdropInfo': 'Check airdrop eligibility, wallet status, and claim history for SP Coin.',
  'SpNetGramCoinBalance': 'SP Coin: %1$s',
  'SpNetGramLinkWallet': 'Link Wallet',
  'SpNetGramClaimAirdrop': 'Claim Airdrop',
  'SpNetGramAirdropReady': 'Airdrop: ready',
  'SpNetGramAirdropNext': 'Airdrop: next %1$s',
  'SpNetGramWalletNotLinked': 'Wallet: not linked',
  'SpNetGramWalletLinked': 'Wallet: %1$s',
  'SpNetGramAirdropClaimed': 'Airdrop: claimed',
  'SpNetGramAirdropUnclaimed': 'Airdrop: unclaimed',
  'SpNetGramWalletLinkedToast': 'Wallet linked.',
  'SpNetGramAirdropClaimedToast': 'Airdrop claimed.',
  'SpNetGramGems': 'Gems',
  'SpNetGramGemsSubtitle': 'Earn and spend Gems',
  'SpNetGramGemsInfo': 'Collect Gems for boosts, cosmetics, and special actions inside SP NET GRAM.',
  'SpNetGramClaimGems': 'Claim 10',
  'SpNetGramGemsBalance': 'Gems balance: %1$s',
  'SpNetGramGemsClaimReady': 'Gems: ready to claim',
  'SpNetGramGemsNext': 'Next claim %1$s',
  'SpNetGramGemsClaimedToast': 'Gems balance: %1$s',
  'SpNetGramPrivacySection': 'Privacy & Power',
  'SpNetGramGhostMode': 'Ghost Mode',
  'SpNetGramGhostModeInfo': 'Hide last seen and online status in this client.',
  'SpNetGramAntiRevoke': 'Anti-Revoke',
  'SpNetGramAntiRevokeInfo': 'Keep messages visible even if they are deleted for you.',
  'SpNetGramHideTyping': 'Hide Typing',
  'SpNetGramHideTypingInfo': 'Don’t send typing indicators while composing messages.',
  'SpNetGramNoReadReceipts': 'No Read Receipts',
  'SpNetGramNoReadReceiptsInfo': 'Avoid sending read receipts when opening chats.',
  'SpNetGramPrivacyInfo': 'Privacy toggles are client-side. Server-side behavior may differ based on SP NET GRAM limitations.',
  'SpNetGramAccess': 'Access',
  'SpNetGramAccessSubtitle': 'License status and expiry',
  'SpNetGramAccessActive': 'Active',
  'SpNetGramAccessLocked': 'Locked',
  'SpNetGramAccessUnknown': 'Unknown',
  'SpNetGramAccessExpires': 'Expires %1$s',
  'SpNetGramAccessNoExpiry': 'No expiry',
  'SpNetGramRedeemLicense': 'Redeem License',
  'SpNetGramRedeemLicenseSubtitle': 'Enter your SP NET GRAM premium key',
  'SpNetGramRedeem': 'Redeem',
  'SpNetGramLicenseGateTitle': 'SP NET GRAM Access',
  'SpNetGramLicenseGateSubtitle': 'A premium license is required to use SP NET GRAM.',
  ...
  'SpNetGramLicenseResetCode': 'Reset code',
  'SpNetGramLicenseResetPassword': 'Reset password',
  'SpNetGramLicenseResetSending': 'Sending reset code…',
  'SpNetGramLicenseResetSent': 'Reset code sent.',
  'SpNetGramLicenseResetUpdating': 'Updating password…',
  'SpNetGramLicenseResetDone': 'Password updated. Sign in now.',
  'SpNetGramLicenseSignIn': 'Sign In',
  'SpNetGramLicenseCreateAccount': 'Create Account',
  'SpNetGramLicenseRedeemTitle': 'License Key',
  'SpNetGramLicenseKeyHint': 'Enter license key',
  'SpNetGramLicenseRedeem': 'Redeem License',
  'SpNetGramLicenseRefresh': 'Refresh Status',
  'SpNetGramLicenseLogout': 'Log out',
  'SpNetGramLicenseChecking': 'Checking access…',
  'SpNetGramLicenseActive': 'Access: active',
  'SpNetGramLicenseRequired': 'Access: license required',
  'SpNetGramLicenseLoginRequired': 'Please sign in to continue.',
  'SpNetGramLicenseCheckFailed': 'Unable to check access.',
  'SpNetGramLicenseMissingFields': 'Please fill in all required fields.',
  'SpNetGramLicenseMissingKey': 'Please enter a license key.',
  'SpNetGramLicenseSigningIn': 'Signing in…',
  'SpNetGramLicenseCreating': 'Creating account…',
  'SpNetGramLicenseRedeeming': 'Redeeming license…',
  'SpNetGramLicenseSignedIn': 'Signed in.',
  'SpNetGramLicenseAccountReady': 'Account created.',
  'SpNetGramLicenseRedeemed': 'License redeemed.',
  'SpNetGramLicenseLoggedOut': 'Signed out.',
  'OK': 'OK',
  ...
  'ReportSentInfo': 'SP NET GRAM moderators will review your report.\nThank you for your cooperation!',
  ...
  'SessionsListInfo': 'The official SP NET GRAM app is available for Android, iPhone, iPad, Windows, macOS and Linux.',
  'SponsoredMessage': 'ad',
  ...
  'PaymentCardSavePaymentInformationInfoLine1': 'You can save your payment info for future use. It will be stored directly with the payment provider. SP NET GRAM has no access to your credit card data.',
  'Done': 'Done',
  ...
  'PrivacyPaymentsClearInfo': 'You can delete your shipping info and instruct all payment providers to remove your saved credit cards. Note that SP NET GRAM never stores your credit card data.',
  ...
  'LimitReachedPinDialogs': 'You can\'t pin more than %1$d chats to the top. Unpin some that are currently pinned – or subscribe to **SP NET GRAM Premium** to double the limit to **%2$d** chats.',
  ...
  'LimitReachedCommunities': 'You are a member of **%1$d** groups and channels. Please leave some before joining a new one — or subscribe to **SP NET GRAM Premium** to double the limit to **%2$d** groups and channels.',
  ...
  'WebSessionsTitle': 'Logged In with SP NET GRAM',
  'TerminateWebSessionText': 'Are you sure you want to disconnect %1$s?',
  'Disconnect': 'Disconnect',
  'TerminateAllWebSessions': 'Disconnect All Websites',
  'AreYouSureWebSessions': 'Are you sure you want to disconnect all websites where you logged in with SP NET GRAM?',
  'ClearOtherWebSessionsHelp': 'You can log in on websites that support signing in with SP NET GRAM.',
  'TerminateWebSessionInfo': 'Click to disconnect from your SP NET GRAM account.',
  'EnablePhotoSpoiler': 'Hide with spoiler',
  'DisablePhotoSpoiler': 'Remove spoiler',
  'LimitReachedFolders': 'You have reached the limit of **%1$d** folders. You can double the limit to **%2$d** folders by subscribing to **SP NET GRAM Premium**.',
  ...
  'LimitReachedSharedFolderInvites': 'You have reached the limit of **%1$d** links. You can double the limit to **%2$d** links by subscribing to **SP NET GRAM Premium**.',
  ...
  'ActionGiftPremiumSubtitle2': 'Subscription for exclusive SP NET GRAM features.',
  'ChatAdmin': 'admin',
  ...
  'ChannelAntiSpamInfo': 'SP NET GRAM will filter more spam, but may occasionally affect ordinary messages. You can report False Positives in Recent Actions.',
  'ChannelLinkInfo': 'Anyone who has SP NET GRAM installed will be able to join your channel by following this link.',
  ...
  'BotWebAppDisclaimerSubtitle': 'You are about to use a mini app operated by an independent party **not affiliated with SP NET GRAM**. You must agree to the Terms of Use for mini apps to continue.',
  ...
  'PremiumNeededForBoosting': 'Only **SP NET GRAM Premium** subscribers can boost channels. Do you want to subscribe to **SP NET GRAM Premium**?',
  ...
  'CantBoostWithGiftedPremiumDescription': 'Because your **SP NET GRAM Premium** subscription was gifted to you, you can\'t use it to boost channels.',
  'MoreBoosts': {
  ...
  'BoostingGiveawayJustStarted': '%s just started a giveaway of SP NET GRAM Premium subscriptions to its followers.',
  'BoostingWinnersDate': '**Winners Selection Date**',
  'BoostingGiveawayPrizes': '**Giveaway Prizes**',
  'BoostingGiveawayMsgInfoPlural1': {
    'other_value': '**%1$d** SP NET GRAM Premium'
  },
  ...
  'BoostingGiveawayHowItWorksText': {
    'one_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s SP NET GRAM Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway is sponsored by the admins of **%2$s**, who acquired **%3$s SP NET GRAM Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingGiveawayHowItWorksTextEnd': {
    'one_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s SP NET GRAM Premium** subscription for %4$s for its followers.',
    'other_value': 'This giveaway was sponsored by the admins of **%2$s**, who acquired **%3$s SP NET GRAM Premium** subscriptions for %4$s for its followers.'
  },
  ...
  'BoostingReceivedPrizeDuration': 'Your prize is a **SP NET GRAM Premium** subscription for %s.',
  'BoostingUnclaimedPrize': 'Unclaimed Prize',
  'BoostingYouHaveUnclaimedPrize': 'You have an unclaimed prize from a giveaway by **%s**.',
  'BoostingUnclaimedPrizeDuration': 'This prize is a **SP NET GRAM Premium** subscription for %s.',
  ...
  'BoostingReceivedGiftDuration': 'Your gift is a **SP NET GRAM Premium**\nsubscription for %s.',
  'BoostingUsedGiftLink': 'Used Gift Link',
  'BoostingGiftLink': 'Gift Link',
  'BoostingLinkUsed': 'This link was used to activate\na **SP NET GRAM Premium** subscription.',
  'BoostingLinkAllows': 'This link allows you to activate\na **SP NET GRAM Premium** subscription.',
  'BoostingLinkAllowsToUser': 'This link allows **%1$s** to activate a **SP NET GRAM Premium** subscription.',
  ...
  'BoostingPremium': 'SP NET GRAM Premium',
  'BoostingStars': 'SP NET GRAM Stars',
  ...
  'LimitReachedChatInFolders': 'Sorry, you can\'t add more than **%1$d** chats to a folder. You can increase this limit to **%2$d** by subscribing to **SP NET GRAM Premium**.',
  ...
  'GiftPremiumActivateErrorTitle': 'You already have SP NET GRAM Premium',
  ...
  'PrivacyLastSeenPremium': 'Subscribe to SP NET GRAM Premium',
  ...
  'PrivacyLastSeenPremiumForPremium': 'Subscribed to SP NET GRAM Premium',
  'PrivacyLastSeenPremiumInfoForPremium': 'Because you are a SP NET GRAM Premium subscriber, you will see the last seen and read time of all users who are sharing it with you – even if you are hiding yours.',
  ...
  'PremiumReadButton2': 'Subscribe to SP NET GRAM Premium',
  ...
  'PremiumLastSeenButton2': 'Subscribe to SP NET GRAM Premium',
  ...
  'AdHidden': 'You will no longer see ads from SP NET GRAM.',
  'SponsoredMessageAdWhatIsThis': 'what\'s this?',
  'RevenueSharingAdsAlertSubtitle': 'SP NET GRAM Ads are very different from ads on other platforms. Ads such as this one:',
  'RevenueSharingAdsInfo1Title': 'Respect Your Privacy',
  'RevenueSharingAdsInfo1Subtitle': 'Ads on SP NET GRAM do not use your personal information and are based on the channel in which you see them.',
  'RevenueSharingAdsInfo2Title': 'Help the Channel Creator',
  'RevenueSharingAdsInfo2Subtitle': '50% of the revenue from SP NET GRAM Ads goes to the owner of the channel where they are displayed.',
  'RevenueSharingAdsInfo3Title': 'Can Be Removed',
  'RevenueSharingAdsInfo3Subtitle': 'You can turn off ads by subscribing to **SP NET GRAM Premium**, and Level %1$s channels can remove them for their subscribers.',
  'RevenueSharingAdsInfo4Title': 'Can I Launch an Ad?',
  'RevenueSharingAdsInfo4Subtitle2': 'Anyone can create an ad to display in this channel — with minimal budgets. Check out the **SP NET GRAM Ad Platform** for details. %1$s',
  ...
  'FactCheckToast': 'This clarification was provided by SP NET GRAM.',
  'FactCheckFooter': 'This clarification was provided by SP NET GRAM.',
  ...
  'AnimatedEffectPremium': 'Subscribe to **SP NET GRAM Premium** to add this animated effect.',
  ...
  'ActionGiftStarsSubtitle': 'With Stars, **%s** is able to unlock content and services on SP NET GRAM.',
  'ActionGiftStarsSubtitleYou': 'Use Stars to unlock content and services on SP NET GRAM.',
  'GiftStarsTitle': 'Gift Stars',
  'GiftStarsSubtitle': 'With Stars, **%s** will be able to unlock content and services on SP NET GRAM.',
  ...
  'StarGiftUpgradeTransferableText': 'Send your upgraded gift to any of your friends on SP NET GRAM.',
  'StarGiftUpgradeTransferableTextPrepaid': '%s will be able to send the gift to anyone on SP NET GRAM.',
  ...
  'StarGiftValueAboutAverage': 'The average sale price of **%s** gifts on SP NET GRAM and Fragment over the past month.',
  ...
  'StarGiftMinimumPriceTooltip': '**%s** is the floor price for **%s** gifts listed on SP NET GRAM and Fragment.',
  'StarGiftAveragePrice': 'Average Price',
  'StarGiftAveragePriceTooltip': '**%s** is the average sale price of **%s** gifts on SP NET GRAM and Fragment over the past month.',
  ...
  'Reported2': 'SP NET GRAM moderators will review your report. Thank you!',
  ...
  'Contacts.PhoneNumber.NotRegistred': 'The person with this phone number is not registered on SP NET GRAM yet.',
  'Channel.UsernameAboutChannel': 'People can share this link with others and can find your channel using SP NET GRAM search.',
  'Channel.UsernameAboutGroup': 'People can share this link with others and find your group using SP NET GRAM search.',
  ...
  'Chat.Message.Ad.Text': 'Unlike other apps, SP NET GRAM never uses your private data to target ads. Sponsored messages on SP NET GRAM are based solely on the topic of the public channels in which they are shown. This means that no user data is mined or analyzed to display ads, and every user viewing a channel on SP NET GRAM sees the same sponsored messages.\n\nUnlike other apps, SP NET GRAM doesn\'t track whether you tapped on a sponsored message and doesn\'t profile you based on your activity. We also prevent external links in sponsored messages to ensure that third parties can’t spy on our users. We believe that everyone has the right to privacy, and technological platforms should respect that.\n\nSP NET GRAM offers a free and unlimited service to hundreds of millions of users, which involves significant server and traffic costs. In order to remain independent and stay true to its values, SP NET GRAM developed a paid tool to promote messages with user privacy in mind. We welcome responsible advertisers at:\n\n%@\n\nSponsored Messages are currently in test mode. Once they are fully launched and allow SP NET GRAM to cover its basic costs, we will start sharing ad revenue with the owners of public channels in which sponsored messages are displayed.\n\nOnline ads should no longer be synonymous with abuse of user privacy. Let us redefine how a tech company should operate – together.',
  ...
  'CustomEmoji.PremiumAlert': 'Subscribe to SP NET GRAM Premium to unlock this emoji. [Read More]()',
  'Date.Today': 'Today',
  ...
  // 'LiteMode.Key.animations.Info': 'Other animations that make SP NET GRAM look amazing.',
  ...
  'PrivacySettings.Voice.PremiumError': 'Only subscribers of [SP NET GRAM Premium]() can restrict receiving Voice and Video Messages.',
  ...
  'PrivacySettingsController.P2p.Desc': 'Disabling peer-to-peer will relay all calls through SP NET GRAM servers to avoid revealing your IP address, but may slightly decrease audio and video quality.',
  ...
  'TwoStepAuth.GenericHelp': 'You have enabled Two-Step verification.\nYou\'ll need the password you set up here to log in to your SP NET GRAM account.',
  ...
  'Premium.Boarding.NoAds.Info': 'No more ads in public channels where SP NET GRAM sometimes shows ads.',
  ...
  'Premium.Boarding.Badge.Info': 'An exclusive badge next to your name showing that you subscribe to SP NET GRAM Premium.',
  ...
  'Premium.Boarding.Title': 'SP NET GRAM Premium',
  'Premium.Boarding.Info': 'Go **beyond the limits** and **unlock dozens of exclusive** features by subscribing to **SP NET GRAM Premium**.',
  'Premium.Boarding.Got.Title': 'You are all set!',
  'Premium.Boarding.Got.Info': 'Thank you for subscribing to SP NET GRAM Premium. Here\'s what is now unlocked.',
  'Premium.Boarding.Peer.Title': '[%@](profile) is a subscriber of\nSP NET GRAM Premium',
  'Premium.Boarding.Peer.Info': 'Owners of SP NET GRAM Premium accounts have exclusive access to multiple additional features.',
  ...
  'Premium.Boarding.About.Title': 'About SP NET GRAM Premium',
  'Premium.Boarding.About.Text': 'While the free version of SP NET GRAM already gives its users more than any other messaging application, **SP NET GRAM Premium** pushes its capabilities even further.\n\n**SP NET GRAM Premium** is a paid option, because most Premium Features require additional expenses from SP NET GRAM to third parties such as data center providers and server manufacturers. Contributions from **SP NET GRAM Premium** users allow us to cover such costs and also help SP NET GRAM stay free for everyone.',
  'Premium.Boarding.About.Tos': 'By purchasing a Premium subscription, you agree to the SP NET GRAM [Terms of Service](terms) and [Privacy Policy](privacy).',
  'Premium.Boarding.AppStore.Cancelled': 'Purchase was canceled or failed.',
  'Premium.Boarding.AppStore.Success': 'You successfully subscribed for SP NET GRAM Premium.',
  ...
  'Premium.Offset.AlreadyHave': 'You already have SP NET GRAM Premium.',
  ...
  'Language.TranslateMessages.Channel.Premium': 'Subscribe to [SP NET GRAM Premium](premium) to translate entire chats.',
  ...
  'Chat.DownloadLimit.Text': {
    'one_value': 'Subscribe to [SP NET GRAM Premium]() to increase download speeds %d time.',
    'other_value': 'Subscribe to [SP NET GRAM Premium]() to increase download speeds %d times.'
  },
  'Chat.UploadLimit.Text': {
    'one_value': 'Subscribe to [SP NET GRAM Premium]() to increase upload speeds %d time.',
    'other_value': 'Subscribe to [SP NET GRAM Premium]() to increase upload speeds %d times.'
  },
  'Chat.Service.Refund': '%@ refunded %@',
  'EnableDarkMode': 'Enable Dark Mode',
  'DisableDarkMode': 'Disable Dark Mode',
  'DisableAnimations': 'Disable Animations',
  'AudioAndVideoTranscription.PremiumAlert': 'Subscribe to SP NET GRAM Premium to unlock video and audio transcription. [Read More]()',
  ...
  'PasscodeLock.Description': 'When a passcode is set, a lock icon appears above your chat list. Tap it to lock your SP NET GRAM.',
  ...
  'PasscodeLock.TapToLock': 'Tap to lock SP NET GRAM.',
  ...
  'BotStorySharingNotSupported': 'Sharing to Stories is not supported in the Web app. Please use one of SP NET GRAM\'s mobile apps.',
  ...
  'VerificationCodesBotDescription': 'Third-party services, like websites and stores, can send verification codes to your phone number via SP NET GRAM instead of SMS. Such codes will appear in this chat.\n\nIf you didn\'t request any codes – don\'t worry! Most likely, someone made a mistake when entering their number.',
  ...
  'StarsRating.Subtitle': 'This rating reflects **%s**’s activity on SP NET GRAM. What affects it:',
  'StarsRating.SubtitleMy': 'This rating reflects your activity on SP NET GRAM. What affects it:',
  'StarsRating.Row1Title': 'Gifts from SP NET GRAM',
  'StarsRating.Row1Subtitle': '100% of the Stars spent on gifts purchased from SP NET GRAM.',
  ...
  'EmailSetup.ChangeSubtitle': 'You will receive SP NET GRAM login codes via email and not SMS. Please enter an email address to which you have access.',
