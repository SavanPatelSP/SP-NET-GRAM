...
public class ContactsController extends BaseController {
    ...
    public String getInviteText(int contacts) {
        String link = inviteLink == null ? "https://spnetgram.spnet.in/download" : inviteLink;
        if (contacts <= 1) {
...
//                });
    ...
    private void applyContactToPhoneBook(ArrayList<ContentProviderOperation> query, TLRPC.User user) {
        ...
        builder.withValue(ContactsContract.Data.DATA2, "SP NET GRAM Profile");
        ...
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        builder.withValue(ContactsContract.Data.DATA2, "SP NET GRAM Voice Call");
        ...
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        builder.withValue(ContactsContract.Data.DATA2, "SP NET GRAM Video Call");
    ...
    public void createOrUpdateConnectionServiceContact(long id, String firstName, String lastName) {
        ...
        try {
            ...
            Cursor cursor = resolver.query(groupsURI, new String[]{ContactsContract.Groups._ID},
                    ...
                    new String[]{"SpNetGramConnectionService", systemAccount.type, systemAccount.name}, null);
            int groupID;
            if (cursor != null && cursor.moveToFirst()) {
                ...
                values.put(ContactsContract.Groups.TITLE, "SpNetGramConnectionService");
