    ...
    private void createPasswordInterface(Context context) {
        ...
        passwordForgotButton.setOnClickListener(v -> {
            if (currentPassword.has_recovery) {
                ...
                builder.setNegativeButton(LocaleController.getString(R.string.RestorePasswordResetAccount), (dialog, which) -> Browser.openUrl(getParentActivity(), "https://spnetgram.spnet.in/deactivate?phone=" + UserConfig.getInstance(currentAccount).getClientPhone()));
            ...
            problemText.setOnClickListener(v -> {
                ...
                if (!email) {
                    ...
                    try {
                        ...
                        mailer.putExtra(Intent.EXTRA_EMAIL, new String[]{"support@spnetgram.spnet.in"});
